...
*Last updated 2026-08-03 (Mac session: email scanner now LOGS transactions into finance_entries, not just pushes — see Notifications section; awaiting deploy + Apps Script update + backfill run).*
