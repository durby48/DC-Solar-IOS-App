...
- `supabase/migrations/` — 10 SQL files, run **manually** by Devon in the Supabase dashboard SQL Editor (no CLI access). Status: **1–10 all confirmed applied (#10 run by Devon 2026-07-27).**
